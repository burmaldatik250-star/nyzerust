...
-- ============================================================
--  ТЕМЫ (тёмный современный стиль)
-- ============================================================
local Themes = {
    NyzeDark = {
        Main        = Color3.fromRGB(0, 170, 255),      -- акцент-синий
        Secondary   = Color3.fromRGB(120, 90, 255),      -- фиолетовый
        Accent      = Color3.fromRGB(0, 255, 200),       -- мятный
        Background  = Color3.fromRGB(14, 15, 20),        -- почти чёрный
...
-- Заглушка — будет переопределена ниже
function toggleFeature(prop, button, statusFrame) end
